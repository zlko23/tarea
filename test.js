const { Tarea, TareaCompuesta } = require("./tarea");
  ...
  \t|  ${t1.codigo}\t\t${t1.duracion} minutos \t$ ${t1.getCosto()}\t\t${t1.complejidad()}\t\t|
  \t|  ${t11.codigo}\t\t${t11.duracion} minutos \t$ ${t11.getCosto()}\t\t${t11.complejidad}\t\t|
  \t|  ${t12.codigo}\t\t${t12.duracion} minutos \t$ ${t12.getCosto()}\t\t${t12.complejidad}\t\t|
  \t|  ${t121.codigo} \t${t121.duracion} minutos \t$ ${t121.getCosto()}\t\t${t121.complejidad}\t\t|
  \t|  ${t122.codigo} \t${t122.duracion} minutos \t$ ${t122.getCosto()}\t\t${t122.complejidad}\t\t|
  \t|  ${t1221.codigo} \t${t1221.duracion} minutos \t$ ${t1221.getCosto()}\t\t${t1221.complejidad}\t\t|
  \t|  ${t1222.codigo} \t${t1222.duracion} minutos \t$ ${t1222.getCosto()}\t\t${t1222.complejidad}\t\t|
  \t|  ${t13.codigo}\t\t${t13.duracion} minutos \t$ ${t13.getCosto()}\t\t${t13.complejidad}\t\t|
  \t|  ${t131.codigo} \t${t131.duracion} minutos \t$ ${t131.getCosto()}\t\t${t131.complejidad}\t\t|
  \t|  ${t132.codigo} \t${t132.duracion} minutos \t$ ${t132.getCosto()}\t\t${t132.complejidad}\t\t|
  \t|_______________________________________________________________|
